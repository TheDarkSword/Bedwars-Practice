...
public class MediumDiagonalBridging extends BridgingSession {

    public MediumDiagonalBridging(BedwarsPractice bedwarsPractice) {
        this(bedwarsPractice, null);
    }

    public MediumDiagonalBridging(BedwarsPractice bedwarsPractice, BridgingSettingsInventory inventory) {
        super(new BridgingConfiguration(BridgingConfiguration.BridgeLength.MEDIUM, BridgingConfiguration.BridgeHeight.NONE, BridgingConfiguration.BridgeDirection.DIAGONAL),
