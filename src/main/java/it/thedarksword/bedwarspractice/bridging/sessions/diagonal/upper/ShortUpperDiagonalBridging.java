...
public class ShortUpperDiagonalBridging extends BridgingSession {

    public ShortUpperDiagonalBridging(BedwarsPractice bedwarsPractice) {
        this(bedwarsPractice, null);
    }

    public ShortUpperDiagonalBridging(BedwarsPractice bedwarsPractice, BridgingSettingsInventory inventory) {
        super(new BridgingConfiguration(BridgingConfiguration.BridgeLength.SHORT, BridgingConfiguration.BridgeHeight.STAIRCASE, BridgingConfiguration.BridgeDirection.DIAGONAL),
