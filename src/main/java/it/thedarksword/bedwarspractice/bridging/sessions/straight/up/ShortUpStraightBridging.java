...
public class ShortUpStraightBridging extends BridgingSession {

    public ShortUpStraightBridging(BedwarsPractice bedwarsPractice) {
        this(bedwarsPractice, null);
    }

    public ShortUpStraightBridging(BedwarsPractice bedwarsPractice, BridgingSettingsInventory inventory) {
        super(new BridgingConfiguration(BridgingConfiguration.BridgeLength.SHORT, BridgingConfiguration.BridgeHeight.SLIGHT, BridgingConfiguration.BridgeDirection.FORWARD),
