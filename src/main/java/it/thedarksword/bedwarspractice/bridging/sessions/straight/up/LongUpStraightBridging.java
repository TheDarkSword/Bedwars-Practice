...
public class LongUpStraightBridging extends BridgingSession {

    public LongUpStraightBridging(BedwarsPractice bedwarsPractice) {
        this(bedwarsPractice, null);
    }

    public LongUpStraightBridging(BedwarsPractice bedwarsPractice, BridgingSettingsInventory inventory) {
        super(new BridgingConfiguration(BridgingConfiguration.BridgeLength.LONG, BridgingConfiguration.BridgeHeight.SLIGHT, BridgingConfiguration.BridgeDirection.FORWARD),
