...
public class ShortUpDiagonalBridging extends BridgingSession {

    public ShortUpDiagonalBridging(BedwarsPractice bedwarsPractice) {
        this(bedwarsPractice, null);
    }

    public ShortUpDiagonalBridging(BedwarsPractice bedwarsPractice, BridgingSettingsInventory inventory) {
        super(new BridgingConfiguration(BridgingConfiguration.BridgeLength.SHORT, BridgingConfiguration.BridgeHeight.SLIGHT, BridgingConfiguration.BridgeDirection.DIAGONAL),
