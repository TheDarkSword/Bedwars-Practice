...
public class EasyKnockbackClutch extends KnockbackClutch {
    ...
    public EasyKnockbackClutch(BedwarsPractice bedwarsPractice, Player player, boolean checkpointEnabled) {
        super(bedwarsPractice, player, KnockBackClutchConfiguration.EASY, checkpointEnabled);
    }
