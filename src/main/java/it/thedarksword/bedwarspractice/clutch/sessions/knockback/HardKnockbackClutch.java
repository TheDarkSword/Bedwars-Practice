...
public class HardKnockbackClutch extends KnockbackClutch {
    ...
    public HardKnockbackClutch(BedwarsPractice bedwarsPractice, Player player, boolean checkpointEnabled) {
        super(bedwarsPractice, player, KnockBackClutchConfiguration.HARD, checkpointEnabled);
    }
